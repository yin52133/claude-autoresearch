...
The user defines the goal. Claude decides how to test ideas inside the declared boundaries.
...
Atomic experiments create causality. If the result changes, Claude knows why.

## 6. Git Is Memory

Kept experiments stay in history. Failed experiments are rolled back. The results log records every experiment — kept or discarded — as the true audit trail.
